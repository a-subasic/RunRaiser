...
class CreateAccountActivity : AppCompatActivity() {
    ...
    private fun initialise() {
        ...
        btnCreateAccount = findViewById<View>(R.id.btn_sign_up) as Button
        mProgressBar = findViewById<View>(R.id.sign_up_progress_bar) as ProgressBar
        tvSignInHere = findViewById<View>(R.id.login_here) as TextView
        ...
        btn_show_password.setOnClickListener {
            ...
            etPassword!!.typeface = login_here.typeface
        ...
        btn_show_confirm_password.setOnClickListener {
            ...
            etConfirmPassword!!.typeface = login_here.typeface
...
class User(val id: String, val email: String, val fullName: String, val username: String, val profilePhotoUrl: String,
           val inTraining: Boolean, val lastLat: Double, val lastLng: Double, val fund: Int)
